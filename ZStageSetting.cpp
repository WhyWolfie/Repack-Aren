...
// 최대인원
#define STAGESETTING_MAXPLAYER_MAX		6
...
// 라운드
#define STAGESETTING_MAXROUND_MAX		7
...
/////////////////////////////////////////////////////////////////////////////////
	...
	if ( pCBType && (pCBType->GetCount() > 0))
	{
		...
		if ( strcmp( pCBType->GetString( pCBType->GetSelIndex()), ZMsg(MSG_MT_DEATHMATCH_SOLO)) == 0)
			...
			nGameType = 12;
		else if ( strcmp( pCBType->GetString( pCBType->GetSelIndex()), ZMsg(MSG_MT_VAMP)) == 0)
			nGameType = 13;
		else if ( strcmp( pCBType->GetString( pCBType->GetSelIndex()), ZMsg(MSG_MT_CS)) == 0)
			nGameType = 14;
		else if ( strcmp( pCBType->GetString( pCBType->GetSelIndex()), ZMsg(MSG_MT_CS_TEAM)) == 0)
			nGameType = 15;
		else if ( strcmp( pCBType->GetString( pCBType->GetSelIndex()), "SKILL WAR") == 0)
			nGameType = 17;	
		else if ( strcmp( pCBType->GetString( pCBType->GetSelIndex()), "STAFF") == 0)
			nGameType = 18;
		else if ( strcmp( pCBType->GetString( pCBType->GetSelIndex()), "INFECTED") == 0)
			nGameType = 19;
	}
