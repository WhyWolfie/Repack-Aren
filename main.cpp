...
RRESULT OnCreate(void *pParam)
{
	...
	sprintf( cstrReleaseDate, "Version : %d - Aren By Colin MacLeod.", ZGetSVNRevision());
...
//#ifdef LOCALE_NHNUSA
/*	BYTE SHA_HanAuthForClient[20] = {0x7e,0x03,0x9d,0xe2,0x26,0xef,0xed,0x6c,0xb4,0x69,0x74,0x05,0x29,0x47,0x53,0x00,0xbc,0x16,0x13,0x06};
	BYTE SHA_hanpollforclient[20] = {0x57,0x7c,0x8d,0x96,0xb0,0x1e,0x73,0x52,0x3a,0xcc,0x93,0x43,0xe5,0x4e,0xe0,0xc9,0x16,0xed,0x78,0xdd};
	BYTE SHA_HanReportForClient[20] = {0x01,0x34,0x79,0xa6,0xd5,0x4b,0xbb,0xc0,0x20,0xbb,0xdd,0x6b,0x32,0xc0,0xa0,0x98,0xdd,0xad,0x4d,0xce}; 
	...
	{
		MessageBox(g_hWnd,"Dll Hacking detected, avoid changing files GUNZ, or another program does not interfere with this.",  NULL, MB_OK);
		return false;
	}
...
//#ifndef _DEBUG
	/*BYTE SHA_fmod[20] = {0xab,0xd1,0x63,0x02,0xa9,0x81,0xd4,0x22,0x6c,0x7f,0xf6,0xf8,0x46,0x1c,0x8d,0x1a,0x75,0x83,0xe7,0x17};
	BYTE SHA_dbghelp[20] = {0x01,0x54,0x1e,0xc7,0xfd,0x80,0x5f,0xf3,0x3e,0xa7,0x3e,0x16,0xb3,0x8e,0x57,0xf8,0xcc,0xe8,0x0b,0x14}; 
	BYTE SHA_system[20] = {0x94,0xa6,0xfe,0x2d,0xe0,0x7c,0xd1,0x8e,0xee,0xb6,0x12,0x53,0xc8,0x28,0x2e,0x00,0x20,0xd1,0x73,0xc5};
