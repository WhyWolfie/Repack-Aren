...
enum MMATCH_GAMETYPE {
	...
	MMATCH_GAMETYPE_VAMP				=13,
	MMATCH_GAMETYPE_CS					=14,	//Counter strike solo
	MMATCH_GAMETYPE_CS_TEAM				=15,	//Counter strike team
	MMATCH_GAMETYPE_SKILLWAR 			=17,
	MMATCH_GAMETYPE_STAFF          		=18,	
...
inline bool MBaseGameTypeCatalogue::IsTeamGame(MMATCH_GAMETYPE nGameType)
{
	...
	if ((nGameType == MMATCH_GAMETYPE_DEATHMATCH_TEAM) ||
		(nGameType == MMATCH_GAMETYPE_CS_TEAM) ||
