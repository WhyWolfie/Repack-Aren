...
///////////////////////////////////////////////////////////////////////////////////////////
class MMatchRuleCs : public MMatchRule {
protected:
	bool CheckKillCount(MMatchObject* pOutObject);
	virtual void OnBegin();
	virtual void OnEnd();
	...
	virtual bool RoundCount();
public:
	MMatchRuleCs(MMatchStage* pStage);
	virtual ~MMatchRuleCs() { }
	virtual MMATCH_GAMETYPE GetGameType() { return MMATCH_GAMETYPE_CS; }
};

class MMatchRuleCsTeamDeath : public MMatchRule {
protected:
...
public:
	MMatchRuleCsTeamDeath(MMatchStage* pStage);
	virtual ~MMatchRuleCsTeamDeath()				{}
	virtual void CalcTeamBonus(MMatchObject* pAttacker, MMatchObject* pVictim,
								int nSrcExp, int* poutAttackerExp, int* poutTeamExp);
	virtual MMATCH_GAMETYPE GetGameType() { return MMATCH_GAMETYPE_CS_TEAM; }
};
...
///////////////////////////////////////////////////////////////////////////////////////////////
class MMatchRuleStaff : public MMatchRule {
protected:
bool CheckKillCount(MMatchObject* pOutObject);
virtual void OnBegin();
virtual void OnEnd();
...
virtual bool RoundCount();
public:
MMatchRuleStaff(MMatchStage* pStage);
virtual ~MMatchRuleStaff() { }
virtual MMATCH_GAMETYPE GetGameType() { return MMATCH_GAMETYPE_STAFF; }
};
