...
enum MMatchUserGradeID
{
	...
	MMUG_EVENTMASTER	= 252,	// Game Master
	MMUG_BLOCKED		= 253,	// Banned
	MMUG_DEVELOPER		= 254,	// Developer
	MMUG_ADMIN			= 255,	// Administrator
	MMUG_MODERATOR		= 251,	// Moderator
	MMUG_POLICE			= 250	// Police
};
...
{ 
	{{1, 5001, 4001, 30301, 0,     520029, 521023, 522018, 523021, 524021},	{1, 5001, 4001, 30301, 0,     520529, 521523, 522518, 523521, 524521}},	// 건나이트
	{{2, 5002, 0,    30301, 0,     520085, 21017,  22013,  23018,  24014},	{2, 5002, 0,    30301, 0,     520585, 21517,  22513,  23518,  24514}},	// 건파이터
	{{1, 4005, 5001, 30401, 0,     520036, 521028, 522023, 523026, 524026},	{1, 4005, 5001, 30401, 0,     520536, 521528, 522523, 523526, 524526}},	// 애서신
	{{2, 4001, 0,    30401, 0,     520029, 521023, 522018, 523021, 524021},	{2, 4001, 0,    30401, 0,     520529, 521523, 522518, 523521, 524521}},	// 스카우트
	{{2, 4002, 0,    30401, 30001, 520085, 21017,  22013,  23018,  24014},	{2, 4002, 0,    30401, 30001, 520585, 21517,  22513,  23518,  24514}},	// 건프리스트
	{{1, 4006, 0,	 30101, 30001, 520036, 521028, 522023, 523026, 524026},	{1, 4006, 4006, 30101, 30001, 520536, 521528, 522523, 523526, 524526}}	// 닥터
};
...
const string g_szFaceMeshName[MAX_COSTUME_FACE][2] = 
{
	...
	{"eq_face_newface08", "eq_face_newface14"},
	{"eq_face_newface09", "eq_face_newface15"},
	{"eq_face_newface10", "eq_face_newface10"},
	{"eq_face_newface11", "eq_face_newface11"},
	{"eq_face_a01", "eq_face_newface12"},
	{"eq_face_newface13", "eq_face_newface13"},
	/*{"eq_face_newface14", "eq_face_newface08"}, 
	{"eq_face_newface15", "eq_face_newface09"},
