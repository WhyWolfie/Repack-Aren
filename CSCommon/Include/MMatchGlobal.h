...
// 각 래더타입별 필요한 인원수
const int g_nNeedLadderMemberCount[MLADDERTYPE_MAX] = {	2, 3, 4, 8, 1 };
...
#define ANNOUNCE_STRING_LEN				256
#define ANNOUNCE_FORUM_STRING_LEN		256
#define MSG_STRING_LEN					256
#define CHAT_STRING_LEN					256
...
#define STAGE__MAX_ROUND				999	// 스테이지에서 사용할 수 있는 최대 라운드 수. 이수를 넘을 수 없다. - By SungE 2007-11-07
// clan
