...
//	CA("connect", "Net.Connect");
	...
	C(MC_ADMIN_FREEZE, "Admin.Freeze", "Freeze targetted player", MCDT_MACHINE2MACHINE)
		P(MPT_STR, "AdminName")
		P(MPT_STR, "TargetName");		

	C(MC_ADMIN_GIVE_COINS, "Admin.Give.Coins", "Give coins to a player.", MCDT_MACHINE2MACHINE)
		P(MPT_STR, "szPlayer")
		P(MPT_INT, "nCoins")	
		
	C(MC_ADMIN_GIVE_EVENTCOINS, "Admin.Give.Coins", "Give coins to a player.", MCDT_MACHINE2MACHINE)
		P(MPT_STR, "szPlayer")
		P(MPT_INT, "nCoins")
