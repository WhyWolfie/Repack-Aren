		...
		case MC_MATCH_LOGIN:
            {
                ...
                if( NULL == pLoginBlob )
                {
                    // Hacker°¡ BlobAC Aⓒ±a¸| A¶A¤CI¸e MCommand¸| ¸¸μe¶§ Blobμ￥AIAI°¡ NULLÆ÷AIAI¸| °¡Au¼o AO´U.
                    break;
                }
		...
		case MC_ADMIN_GIVE_EVENTCOINS:
			{
				...
				OnAdminGiveEventCoins(pCommand->GetSenderUID(), szPlayerName, nCoins);
			}
			break;	
