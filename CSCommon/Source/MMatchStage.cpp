...
MMatchRule* MMatchStage::CreateRule(MMATCH_GAMETYPE nGameType)
{
	...
	case MMATCH_GAMETYPE_CS:
		{
			return (new MMatchRuleCs(this));
		}
		break;		
	case MMATCH_GAMETYPE_CS_TEAM:
		{
			return (new MMatchRuleCsTeamDeath(this));
		}
		break;		
	...
	case MMATCH_GAMETYPE_VAMP:
		{
			return (new MMatchRuleVamp(this));
		}
		break;	
	...
	case MMATCH_GAMETYPE_STAFF:
		{
			return (new MMatchRuleStaff(this));
		}
		break;		
...
void MMatchStage::SetRelayMapList(RelayMap* pRelayMapList)
{
	...
	{
		// dude skill war
		/*if ( GetStageSetting()->GetGameType() == MMATCH_GAMETYPE_SKILLWAR )
		{
			pRelayMapList[0].nMapID = MMATCH_MAP_SkillMapV1;
			count = 1;
		}
		else
		{*/
