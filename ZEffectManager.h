...
#define BULLETONWALL_COUNT	2
	...
	//Vamp declaration
    ZEffectBulletMarkList        m_VampMarkList;
    ZEffectBulletMarkList        m_Vamp2MarkList;
    ZEffectBulletMarkList        m_Vamp3MarkList;
    ZEffectBulletMarkList        m_Vamp4MarkList;
    ZEffectBulletMarkList        m_Vamp5MarkList;
    ZEffectBulletMarkList        m_Vamp6MarkList;
    ZEffectBulletMarkList        m_Vamp7MarkList;
