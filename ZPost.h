...
inline void ZPostGiveCoins(char* pszTargetName, const int nCoins)
{
	ZPOSTCMD2(MC_ADMIN_GIVE_COINS, MCmdParamStr(pszTargetName), MCmdParamInt(nCoins));
}

inline void ZPostGiveEventCoins(char* pszTargetName, const int nCoins)
{
	ZPOSTCMD2(MC_ADMIN_GIVE_EVENTCOINS, MCmdParamStr(pszTargetName), MCmdParamInt(nCoins));
}
#ifdef _DEBUG
