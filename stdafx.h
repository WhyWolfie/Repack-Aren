...
#if defined(_DEBUG) || defined(_RELEASE) || defined(LOCALE_KOREA) || defined(LOCALE_NHNUSA) || defined(LOCALE_JAPAN) || defined(LOCALE_BRAZIL) || defined(LOCALE_US) || defined(LOCALE_INDIA)// || defined(_DEBUG)
	#define _MULTILANGUAGE	// 다중언어 지원 여부
#endif

#if defined(_DEBUG) || defined(_RELEASE) || defined(LOCALE_KOREA) || defined(LOCALE_NHNUSA) || defined(LOCALE_JAPAN) || defined(LOCALE_BRAZIL) || defined(LOCALE_US) || defined(LOCALE_INDIA)
