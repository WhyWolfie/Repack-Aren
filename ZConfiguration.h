...
#include "AdjustableFOV.h" // [addon] adjustable FOV
...
struct ZCONFIG_VIDEO
{
	...
	int nTextureFormat;
	bool bTerrible;
	ZAddons_Francesco_AdjustableFOV_VideoConfig // [addon] adjustable FOV
};
...
#define ZTOK_ETC_TRAIL_OPTION		"TRAILOPTION"	//Trail Option
